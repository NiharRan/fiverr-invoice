                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo BASE_URL; ?>customers/store" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="phone" class="form-control" value="<?php echo old_data('phone'); ?>">
                        </div>
                        <div class="form-group">
                            <label>E-mail</label>
                            <input name="email" type="email" class="form-control" value="<?php echo old_data('email'); ?>">
                            <span class="help-block"><?php echo show_error('email'); ?></span>
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                            <input name="address" class="form-control" value="<?php echo old_data('address'); ?>">
                        </div>
                        <div class="form-group <?php echo has_error('city') ? 'has-error' : ''; ?>">
                            <label>City</label>
                            <input name="city" class="form-control" value="<?php echo old_data('city'); ?>">
